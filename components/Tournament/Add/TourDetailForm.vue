  ...
  <section class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
      ...
      <UFormField label="عدد الصكات في المباريات العادية " name="SakkaNormalOption">
        <USelect v-model="modelValue.SakkaNormalOption" :items="SakkaOptions"
          placeholder="اختر عدد الصكات في المباريات العادية" />
      </UFormField>
      <UFormField label="عدد الصكات في المباريات النهائية" name="SakkaFinalMatchOption">
        <USelect v-model="modelValue.SakkaFinalMatchOption" :items="SakkaOptions"
          placeholder="اختر عدد الصكات في المباريات النهائية" />
      </UFormField>
    </div>
  </section>
</template>
