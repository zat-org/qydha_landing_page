  ...
  <UCard :ui="{base:'flex flex-col h-full',body:{base:'grow'}}">
    ...
    <template #footer>
      <div class="flex justify-between items-center">
        <UButton type="submit" label="تعديل" color="yellow" @click="UpdateForm?.submit()" />
        
        <UButton type="button" class="ml-auto mr-[10px]" v-if="roles?.includes('SuperAdmin')||roles?.includes('StaffAdmin')"
         label=" تعديل الصور والمالك " color="yellow" @click="openUpdateModal" />
