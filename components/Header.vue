<template>
    ...
    <div class="border-b  border-[#F6BD68]  bg-[#1d2145] flex flex-row justify-around items-center pb-2 text-white ">
        ...
        <UButton v-if="authstore.logedin" color="black" icon="fontisto:nav-icon-a" @click="openNav" class="mr-2"  ></UButton>
        <div class="flex justify-center items-center mx-auto">
            <NuxtLink to="/"><img src="@/assets/images/qydha-logo.svg" class="w-20" alt="Qydha Logo" /></NuxtLink>
        </div>
        <UButton v-if="!authstore.logedin" color="black" icon="mdi:user" to="/login"  class="ml-2" ></UButton>
        <UButton v-else color="black" icon="simple-line-icons:logout" @click="onLogOut" class="ml-2" ></UButton>
