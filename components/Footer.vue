...
<template>
  <div
    class="p-3 border-t border-[#F6BD68] bg-transparent flex flex-col md:flex-row space-y-3 md:space-y-0">
    <div class="w-full md:w-1/4 flex justify-center items-center">
      <NuxtLink to="/"
        ><img src="@/assets/images/qydha-logo.svg" alt="Qydha" class="w-28"
      /></NuxtLink>
    </div>
    ...
    <div class="w-full md:w-1/4 flex justify-center items-center">
      <a
        href="https://twitter.com/QydhaApp"
        target="_blank"
      ...
      <a
        href="https://www.instagram.com/qydhaapp/"
        target="_blank"
        class="h-10 w-10 bg-gray-300 rounded-full flex justify-center items-center mx-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="256"
          height="100"
