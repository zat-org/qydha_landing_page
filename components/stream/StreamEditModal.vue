...
const resetBoard = async () => {
  const defaultTableData: TableUpdate = {
    ...
    scorePanel: {
      ...
      leftTeam: {
        name: { size: 50, top: -4, left: 152, width: 50, height: 100 },
        score: { size: 50, top: 11, left: 429, width: 20, height: 100 },
      },
      rightTeam: {
        name: { size: 50, top: -4, left: 143, width: 50, height: 100 },
        score: { size: 50, top: 11, left: 19, width: 20, height: 100 },
      },
    },
    LeftPlayer: { top: 0, left: 0 },
    RightPlayer: { top: 0, right: 0 },
