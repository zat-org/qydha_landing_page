    ...
    <section id="download-section" class="flex justify-center items-center">
        <div class="w-full lg:w-1/2 space-y-5 mt-10 lg:mt-0  text-center lg:text-right">
            ...
            <div class="mt-10 flex justify-center lg:justify-start">
                <a href="https://apps.apple.com/in/app/qydha/id6446068415" target="_blank"><img
                        src="/images/app_store_badge_ar.svg" class="w-40 lg:w-52 me-5" /></a>
                <a href="https://play.google.com/store/apps/details?id=com.qydha&pli=1" target="_blank"><img
                        src="/images/google_store_badge_ar.svg" class="w-40 lg:w-52 ms-5" /> </a>
            </div>
            <!-- <h5 class="mt-10 mb-3">للدعم الفني تواصل معنا من خلال البريد الالكتروني</h5> -->
