...
import { type TournamentCreationRequest } from '~/features/tournament/models/tournamentRequest';
...
const getStepForField = (error: any): number => {
    ...
    const step0Fields = ['title', 'description', 'logo', 'contactPhone','isContactPhoneCall', 'isContactPhoneWhatsapp','locationDescription', 'location', 'type','tournamentPrivatePassword', 'sponsors'];
    const step1Fields = ['startAt', 'endAt', 'joinRequestStartAt','joinRequestEndAt', 'joinRequestMaxCount','isAddPlayersByQydha', 'prizes', 'teamsCount','tablesCount'];
