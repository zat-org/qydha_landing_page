  ...
  <UCard class="max-w-7xl mx-auto  bg-gray-50 dark:bg-gray-900 ">
    ...
    <UForm :schema="localSchema" :state="modelValue" class="flex flex-col space-y-6  " ref="form">
      ...
      <div class="flex items-center justify-between">
        ...
        <UButton v-if="sponsersAvilabel" @click="AddSponser()" color="primary" variant="soft" icon="i-heroicons-plus" size="sm">إضافة راعي</UButton>
...
const removeLogo = () => { logoImageUrl.value = ""; props.modelValue.logo = undefined; }
