...
export enum TournamentDetailedState {
  ...
  LinkingQualificationStageTeams = "LinkingQualificationStageTeams",
  ManagingQualificationStageBrackets = "ManagingQualificationStageBrackets",
  WaitingQualificationStageStarting = "WaitingQualificationStageStarting",
  QualificationStageRunning = "QualificationStageRunning",
  QualificationStageFinished = "QualificationStageFinished",
  ManagingFinalStageQualifiedTeams = "ManagingFinalStageQualifiedTeams",
