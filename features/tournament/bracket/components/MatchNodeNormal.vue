<template>
  <div
    dir="rtl"
    class="flex w-[450px] flex-col gap-2 overflow-hidden rounded-2xl p-2 text-sm font-semibold shadow-sm ring-1 ring-black/5 backdrop-blur-[1px] transition-all duration-300 hover:shadow-xl dark:ring-white/10"
