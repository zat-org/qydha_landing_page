<template>
  <div class="mt-4 space-y-12 px-4 pb-8 sm:px-8">
    ...
    >
      ...
      <div
        class="border-t border-dashed border-gray-200/90 dark:border-gray-700/90"
        aria-hidden="true"
      />
      ...
      <div aria-label="مسار البطولة">
        <div class="mb-3 flex flex-wrap items-center justify-between gap-2">
          ...
          <p class="hidden text-[11px] text-gray-500 dark:text-gray-400 sm:block">
            مرّر أفقياً لرؤية كل المراحل
          </p>
        </div>
        <div
        ...
        >
          <div
            class="-mx-1 overflow-x-auto scroll-smooth overscroll-x-contain px-1 pb-2 touch-pan-x"
            dir="rtl"
          >
            <div class="flex min-w-max items-start gap-0 py-1">
              <template v-for="(phase, idx) in phaseOrder" :key="phase">
                <div
                  class="flex w-[108px] shrink-0 snap-center flex-col items-center sm:w-[112px]"
                >
                  <div
