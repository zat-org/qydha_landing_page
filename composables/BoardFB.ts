      ...
      scorePanel: {
        ...
        leftTeam: {
          name: {
            ...
            width: `${newData.scorePanel.leftTeam.name.width}px`,
          ...
          score: {
            ...
            width: `${newData.scorePanel.leftTeam.score.width}px`,
        ...
        rightTeam: {
          name: {
            ...
            width: `${newData.scorePanel.rightTeam.name.width}px`,
          ...
          score: {
            ...
            width: `${newData.scorePanel.rightTeam.score.width}px`,
